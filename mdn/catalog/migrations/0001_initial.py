# Generated by Django 3.0.3 on 2020-02-18 05:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language', models.CharField(blank=True, choices=[('en', 'English'), ('sp', 'Spanish'), ('cs', 'Chinese Simplified'), ('ct', 'Chinese Traditional')], default='cs', max_length=2)),
            ],
            options={
